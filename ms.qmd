---
title: "Antipredator strategies are robust to prenatal CORT and temperature in two skink species"
format:
  docx: 
...
Predation risk is a prominent ecological pressure that can shape the behavior, physiology, and life histories of prey species [@lima1990behavioral; @brown1999ecology]. To reduce the likelihood of being detected, attacked or captured, prey animals have developed a suite of antipredator strategies, including morphological defences, behavioral tactics, and physiological adjustments [@stankowich2005fear]. However, these strategies are usually costly, leading to trade-offs between predator avoidance and other fitness-related traits [@lima1990behavioral; @stankowich2005fear]. To optimize benefits, animals must carefully evaluate predation risks and respond accurately to them, adjusting their responses to changing risk levels [@lima1990behavioral; @chen2025zebra]. Animals are therefore expected to exhibit plasticity in their antipredator strategies, adjusting their behavior and physiology according to the level of risk they face [@lima1990behavioral; @stankowich2005fear].       

However, there is considerable variation in how animals cope with predation risk [@stankowich2005fear; @thaker2009alternative; @horvath2020ain]. Some individuals consistently exhibit strong antipredator responses while others adjust more accurately their strategies under changing risk [@stankowich2005fear; @thaker2009alternative]. Cognition and the stress response system can be key factors predicting individual differences in the antipredator strategies [@griffin2001learning; @kelley2003learned; @shier2007effects; @thaker2009acute; @thaker2010stress]. Making informed decisions about when and how to respond to a threat relies both cognitive processes associated to detecting and recognising predators as well as cognitive processes associated to animals' ability to adjust their behaviour over time, also known as antipredator plasticity in the prey-predator context [@kim2016fixed]. In addition, the stress response system--mediated by the hypothalamic-pituitary-adrenal (HPA) or hypothalamic-pituitary-interrenal (HPI) axis--also plays a crucial role in mediating behavioral and physiological responses to predation [@thaker2009acute; @thaker2010stress]. Under threat, the HPA/HPI axis triggers the release of glucocorticoids (GCs), which help mobilize resources to cope with imminent risk [@sapolsky_how_2000]. Individual differences in HPA/HPI reactivity can influence the intensity and duration of antipredator responses, as well as the ability to adjust these responses [@koolhaas1999coping]. Therefore, any factors influencing cognitive processes or HPA/HPI function will affect antipredator strategies and their plasticity.   

Early-life environment is a critical factor for the development of both cognitive processes and the HPA/HPI axis function [@lemaire_prenatal_2000; @jafari2017prenatal; @abayarathna_effects_2020; @crino2024eggs]. Stressful conditions during development can lead to long-lasting alterations in cognitive abilities and GCs regulation [@lemaire_prenatal_2000; @zhu_prenatal_2004; @jafari2017prenatal; @crino2024eggs]. For example, prenatal stress increases HPA/HPI responsiveness through different pathways like sustained elevated baseline GC, higher increases in the secretion of GCs after a disturbance, or a reduction in GC recovery [@crino_corticosterone_2014; @thayer2018impact; @crino2024eggs]. Although evidence is mixed, most studies suggest that the effects of prenatal GC elevations on HPA/HPI function produce individuals that are more reactive to predation risk, for example by hiding for longer after a threat or by increasing flight initiation distance [@koolhaas1999coping; @jafari2017prenatal]. In addition, elevating GCs during development can impair cognitive processes involved in learning and memory [@lemaire_prenatal_2000; @zhu_prenatal_2004], directly affecting antipredator plasticity. However, the effects of prenatal stress on antipredator responses and plasticity may be amplified or buffered by other factors. Temperature is particularly relevant in this regard, as a prominent driver of cognitive processes in ectotherms, including those associated with predator recognition and antipredator plasticity [@burger_antipredator_1998; @amiel_smart_2011; @dayananda_incubation_2017; @noble_developmental_2018; @vila_pouca_incubation_2018; @vila_pouca_quantity_2019; @abayarathna_effects_2020]. Yet, the combined effects of prenatal stress and thermal environment on antipredator strategies and their plasticity remain poorly understood.    

The aim of the present study is to examine how prenatal conditions--particularly prenatal GCs exposure and thermal environment--can shape the antipredator strategies in lizards. We investigated the combined effects of prenatal corticosterone (CORT)--the primary GC in reptiles--and incubation temperature on the immediate antipredator behavior and the antipredator plasticity in two closely related skink species, the delicate skink (_Lampropholis delicata_) and the common garden skink (_L. guichenoti_). We experimentally manipulated CORT levels in eggs and incubated them at either cold or hot temperatures. After hatching, we assessed the lizards' immediate antipredator response  (i.e. longer time spent freezing or hiding after a threat) and their ability to adjust this behavior over repeated exposures to a simulated predator attack. We expected lizards to exhibit a strong antipredator response immediately after the simulated attack, which would either increase or decrease over time indicating sensitisation or habituation respectively. The magnitude of change across trials was used as a measure of antipredator plasticity.       

Given the known effects of prenatal GCs on brain development and HPA/HPI function [@jafari2017prenatal; @lemaire_prenatal_2000; @abayarathna_effects_2020; @crino2024eggs], we hypothesized that prenatal CORT exposure would enhance immediate antipredator response but reduce antipredator plasticity. We did not expect a main effect of incubation temperature on the immediate antipredator response [@iglesias2024maternal], but incubation at warmer temperatures is predicted to enhance antipredator plasticity by enhancing cognitive processes [@amiel_smart_2011; @amiel_hotter_2012; @amiel_effects_2017], likely buffering the effects of prenatal CORT.  

Finally, we explored potential species differences in the effects of prenatal conditions on antipredator strategies. Only _L. delicata_ has been reported as a successful coloniser outside their natural range despite both species sharing similar life-histories, habitats, and distributions [@chapple_know_2011; @chapple_biology_2014]. These differences in the ability to colonise new environments are not related to cognitive abilities [@chapple_know_2011; @recio2025cognitive; @recio2025early], but could be associated with differences in personality [@chapple_know_2011], which may be linked to different antipredator strategies and plasticity [@amo2005flexibility; @horvath2020ain]. _Lampropholis delicata_ are generally bolder than _L. guichenoti_ [@chapple_know_2011], which could translate into weaker immediate antipredator responses. However, we predict _L. delicata_ to show greater antipredator plasticity, which allows for better adjustment to novel predator communities.                    
...
Three weeks before the start of the behavioral tests, we adapted the lizard enclosures to the experimental setup. The enclosures used for the antipredator response trials were the same as those where the lizards had previously been housed, but modified to include only a single shelter (9 × 6 × 1.5 cm) placed at one end and a water dish in the centre. All other shelter materials and the matting substrate were removed to allow continuous monitoring. The enclosures were relocated to two experimental rooms, each containing six racks equipped with their own CCTV system (model DVR-HP210475). The number of lizards per treatment was counterbalanced across racks to control for potential effects of room or rack position. In these three weeks, lizards were fed one calcium- and multivitamin-dusted cricket per day, and water was provided _ad libitum_. A temperature gradient was maintained using heat cords and heat lamps on a 12:12 h light–dark cycle, with room temperatures kept between 22–24 °C.          

To test the effects of prenatal conditions on the antipredator strategies, we simulated a predatory attack once daily over eight days. Each trial began with one of the researchers (PR) removing the water dish from the enclosure, followed by the removal of the shelter. The lizard was then chased for 60 seconds using a soft paintbrush, simulating the predatory attack. Immediately after the chase, the shelter—-but not the water dish-—was returned to its original position, marking the start of the behavioral observation period. The lizard’s behavior was then recorded for one hour. All videos were later analyzed by MD, who was blinded to the lizards’ treatment. From each video, we recorded three behavioral variables: i) latency to move-—the time spent immobile immediately after the simulated attack; ii) latency to shelter—-the time it took the lizard to hide under the shelter after resuming movement; and iii) probability to emerge-—whether or not the lizard emerged from the shelter during the 40 minutes following hiding (1 = emerged, 0 = did not emerge). A lizard was considered to have resumed movement if it moved continuously for at least five seconds, and to be under shelter if no limbs were visible. All trials were conducted between 1000–1400 h, when lizards were most active.       
...
We performed the analyses for each species separately. We fitted a total of six Bayesian mixed models using the _brm_ package [@burkner2017brms] in _Stan_ [@stan] in R version 4.5.1 [@R]. We ran four parallel MCMC chains of 10000 iterations for each model, with a warmup period of 4000 iterations. 

We used as the response variables the latency to move, the latency to shelter, and the probability to emerge, modelled separately. We included the prenatal condition (Control-Cold, CORT-Cold, Control-Hot, CORT-Hot), the trial number, and their interaction as fixed effects. To facilitate interpretation of the model intercepts, trial day was transformed so that trial 1 in the experiment corresponds to trial 0 in the model. We also included snout-vent length--measured one day before the beginning of the trials--as a covariate, as body size 
influences predation risk and escape performance in lizards [@stankowich2005fear]. In this regard, prenatal exposure to corticosterone and thermal incubation conditions can influence early post-hatching growth in lizards [@crino2024eggs], meaning that size differences among 
treatment groups may partly reflect treatment effects rather than independent variation. Including SVL as a covariate therefore allows us to estimate the direct effect of prenatal condition on antipredator behavior while accounting for SVL-mediated pathways. SVL was centered to the mean to facilitate interpretation of the intercepts.     
...
We used the posterior distributions of model parameters to test for differences between prenatal conditions. Differences in the model intercepts between conditions were interpreted as differences in the immediate antipredator behavior, while differences in the slopes were interpreted as differences in antipredator plasticity. We used the 95% Highest Posterior Density Intervals (95% HPDI) using the hdi function in bayestestR [@bayestestR] to test if the contrasts between treatments or the slopes for each treatment were different from zero. Differences between species were also tested using contrasts comparissons and 95% HPDI to test if the contrasts differed from zero.     
...
#### Do prenatal conditions affect the immediate antipredator response?

_Lampropholis delicata_: We did not see any effect of prenatal CORT, temperature, or their interaction on the immediate antipredator response of _L. delicata_ (see @fig-results_beh_deli A, D, G and Table S1 in _Supplementary Material_). We did not see any effect of SVL on any of the behavioral responses (see Table S4 in _Supplementary Material_) either.         


_Lampropholis guichenoti_: We found that cold-incubated lizards were more likely to emerge from shelter after a simulated attack than warm-incubated lizards (Median ~Hot-Cold~ = `r format_dec(guich_emergence_contrasts$median_Temperature_int, 3)`; 95% HPDI = [`r format_dec(guich_emergence_contrasts$X2.5.HDI_Temperature_int, 3)`, `r format_dec(guich_emergence_contrasts$X97.5.HDI_Temperature_int, 3)`]). However, we did not see any effect of prenatal CORT nor the temperature-CORT interaction on the immediate antipredator response of _L. guichenoti_ (see @fig-results_beh_guich A, D, G and Table S2 in _Supplementary Material_). We did not see any effect of SVL on any of the behavioral responses (see Table S5 in _Supplementary Material_) either.       
...
#### Do prenatal conditions affect the antipredator plasticity?

_Lampropholis delicata_: CORT-treated lizards incubated at cold temperatures increased their latency to move after the simulated attack throughout the experiment (Slope (denoted hereafter as β) = `r format_dec(median(deli_move_posteriors$slope_CORT_Cold), 3)`; 95% HPDI = [`r format_dec(hdi(deli_move_posteriors$slope_CORT_Cold, credMass = 0.95)[1], 3)`, `r format_dec(hdi(deli_move_posteriors$slope_CORT_Cold, credMass = 0.95)[2], 3)`]), while the slopes were not different from zero in the rest of the treatments (see @fig-results_beh_deli B, C and Table S3 in _Supplementary Material_). However, constrasts between between treatments showed no effect of prenatal conditions on the latency to move after the simulated attack throughout the experiment (see Table S1 in _Supplementary Material_). Lizards from all treatments increased the probability of emerging from the shelter throughout the experiment (β > 0 in all cases, see @fig-results_beh_deli H, I and Table S3 in _Supplementary Material_), with no differences between treatments (see Table S1 in _Supplementary Material_). In contrast, the latency to shelter did not change over time (β = 0 in all cases, see @fig-results_beh_deli E, F and Table S3 in _Supplementary Material_). The contrasts between treatments showed no differences in the slopes (see Table S1 in _Supplementary Material_).     


_Lampropholis guichenoti_: Slopes were no different from 0 in any behaviour in _L. guichenoti_ (see @fig-results_beh_guich B, C, E, F, H, I and Table S3 in _Supplementary Material_).       
...
#### Do species differ in their antipredator response and plasticity?

Neither the immediate antipredator response nor the antipredator plasticity differed between species for any of the treatments and behavioral responses analyzed (see @table-species-contrasts).

_Table 1. Contrasts between species for the intercepts (Response) and slopes (Plasticity) of all the behavioral responses analyzed. Values represent the median (Contrast) and 95% Highest Posterior Density Intervals (95% HPDI) of the posterior distributions of the contrasts. For all contrasts, we calculated the differences between Lampropholis delicata - Lampropholis guichenoti. We did not transform the values back to original units. Detectable differences (95% HPDI does not include 0) are indicated in bold._
```{r, table-species-contrasts}
#| label: table-species-contrasts
#| tbl-cap: "Contrasts between species for the intercepts (Response) and slopes (Plasticity) of all the behavioral responses analyzed. Values represent the median (Contrast) and 95% Highest Posterior Density Intervals (95% HPDI) of the posterior distributions of the contrasts. For all contrasts, we calculated Lampropholis delicata - Lampropholis guichenoti. We did not transform the values back to original units. Detectable differences (95% HPDI does not include 0) are indicated in bold."
source(here("R", "func.R"))
#
...
We predicted that prenatal CORT exposure would enhance the immediate antipredator response and reduce antipredator plasticity, and that warmer incubation temperatures would buffer the effects of CORT on antipredator plasticity through enhanced cognitive processes. Contrary to these predictions, we found no effects of prenatal CORT on the immediate antipredator response in either species. However, _L. guichenoti_ lizards incubated at cold temperatures were more likely to emerge from the shelter after the simulated attack on the first trial, suggesting that incubation temperature influences some antipredator decisions in this species. Evidence for effects of prenatal conditions on antipredator plasticity was also weak, while CORT-treated _L. delicata_ incubated at cold temperatures showed a tendency to increase latency to move over time, contrasts revealed no differences between treatment slopes. Results were even clearer in _L. guichenoti_, where no treatment effects on plasticity were detected. Similarly, while _L. delicata_ increased the probability of emerging from shelter over time-—unlike _L. guichenoti_-—contrasts between species revealed no differences in slopes. Overall, our results suggest that the antipredator response and plasticity of these skinks are robust to prenatal CORT exposure and incubation temperature, and that both species show similar antipredator strategies.    

#### Immediate antipredator response is robust to prenatal CORT but may be influenced by incubation temperature in _L. guichenoti_       
We hypothesized that elevated prenatal CORT would enhance antipredator immediate response, which would translate into increased latency to move, decreased the latency to shelter, and reduced probability of emerging from the shelter after a simulated attack. In contrast, we did not predict incubation temperature to have a main effect on the immediate antipredator response [@iglesias2024maternal]. While we did not see any effects of prenatal CORT on the immediate antipredator response in either species, we found that cold-incubated _L. guichenoti_ were more likely to emerge from shelter after the simulated attack than hot-incubated ones. 

Our results suggest that, contrary to our expectations, incubation temperature may influence some antipredator decisions in _L. guichenoti_. While thermal environment has been shown to impact antipredator behavior in other reptiles like pine snakes (_Pituophis melanoleucus_) [@burger_antipredator_1998], incubation temperature alone did not affect antipredator behavior in _L. delicata_ or _L. guichenoti_ in previous studies [@iglesias2024maternal]. Our results align with previous research for _L. delicata_, but not for _L. guichenoti_. While @iglesias2024maternal found no effect of incubation temperature on emergence latency in _L. guichenoti_ over a 90-minute observation window, cold-incubated individuals in our study showed a higher probability of emerging from shelter within 40 minutes following a more prolonged simulated attack. Exposing animals to a threat for a longer period may have induced a stronger antipredator response, which may have allowed us to detect subtle differences between incubation temperatures in _L. guichenoti_. Alternatively, the two studies may have captured different aspects of the antipredator decision process — our 40-minute window reflecting the threshold to resume activity after a threat, while the 90-minute window of @iglesias2024maternal captured the full dynamic of post-threat behaviour. Differences between both studies indicate that methodological choices in behavioural measurements can meaningfully influence conclusions about antipredator strategies. Future research should explore emergence behaviour across varying threat intensities to clarify the nature of incubation temperature effects on antipredator decisions in _L. guichenoti_.    

Given the previously reported effects of prenatal GCs on the development of the HPA/HPI axis reported in other species [@costantini2011meta; @vargas2016early; @jafari2017prenatal; @zito2017early; @crino2024eggs], we predicted prenatal CORT elevations to increase lizards’ reactivity to a simulated attack. However, we found no effects of prenatal CORT elevations on any of the behaviors analyzed, and these results were consistent across species. These findings suggest that the immediate antipredator response is robust to prenatal CORT elevations in _L. delicata_ and _L. guichenoti_. Alternatively, our CORT manipulation may have failed to elicit detectable effects. Glucocorticoids are known to have hormetic effects on different traits [@mcewen_concept_2003]. While our CORT treatment was efficient in elevating yolk CORT concentrations, they did not result in increased baseline CORT in juveniles [@crino2024eggs]. In contrast, doses at lower concentration did [@crino2024eggs]. Previous reports show that enhanced responsiveness to predatory attempts are usually accompanied by higher baseline GC levels [@koolhaas1999coping; @ruys2004behavioral; @thaker2009acute]. Therefore, the absence of CORT effects on the antipredator response may reflect the lack of endocrine differences between treatment groups in _L. delicata_. However, this mechanism remains speculative for _L. guichenoti_, as comparable endocrine data are currently lacking. Further experiments would benefit from studying how exposing eggs to lower CORT concentrations influence antipredator behaviors and stress-related physiology in both species.    

#### Antipredator plasticity seems robust to prenatal conditions

*The interpretation of prenatal condition effects on antipredator plasticity is complicated by the limited evidence of plasticity in these species under our experimental conditions. If antipredator plasticity is inherently low or absent in captive-raised skinks exposed to repeated simulated attacks, detecting treatment-driven modulation of plasticity would be difficult regardless of the manipulation. The weak plasticity observed in L. delicata suggests some capacity for behavioural adjustment exists, but whether prenatal conditions could modulate this under different experimental conditions — for instance with more trials, longer intervals, or different threat intensities — remains an open question.*

We did not find any effect of prenatal CORT exposure, incubation temperature, or their interaction on antipredator plasticity, neither in _L. delicata_, where there was some evidence of plasticity, or in _L. guichenoti_, where no antipredator plasticity was observed.     

Both prenatal CORT exposure and cold incubation temperatures have been shown to impair cognitive abilities in other species [@lemaire_prenatal_2000; @zhu_prenatal_2004; @amiel_hotter_2012; @costantini2011meta]. Given that antipredator plasticity can be influenced by cognitive processes such as learning and memory [@griffin2001learning; @kelley2003learned; @shier2007effects; @thaker2009acute; @thaker2010stress], we expected prenatal CORT and incubation temperature to influence antipredator plasticity. However, our results suggest that antipredator plasticity in these species is robust to prenatal CORT exposure and incubation temperature. Our findings align with previous research showing that reversal learning--a standardized proxy of behavioral plasticity--was also unaffected by prenatal CORT and incubation temperature in both species [@recio2025early]. These results suggest that some cognitive processes may be robust to prenatal CORT exposure and incubation temperature in these species. However, the effects of prenatal GCs and thermal environment on brain development are region-dependent, with some brain nuclei being more impacted than others [@coomber_independent_1997; @lemaire_prenatal_2000]. Hence, different cognitive processes, encoded in different brain regions, may be more sensitive to the effects of early conditions. Future research should explore the combined effects of prenatal CORT and temperature on brain function and other cognitive domains and how these impact antipredator strategies.   

#### Antipredator response and plasticity do not differ between species
Both _L. delicata_ and _L. guichenoti_ have similar life-histories and ecological niches [@chapple_know_2011; @chapple_biology_2014]. However, while _L. delicata_ is a successful invader in several parts of the world, _L. guichenoti_ has not established populations outside its native range [@chapple2015deliinvLHI]. These differences in invasion success are likely related to differences in behavioral traits, with _L. delicata_ being more exploratory than _L. guichenoti_ [@chapple_know_2011]. Given these differences, we expected _L. delicata_ to show weaker antipredator responses and higher antipredator plasticity than _L. guichenoti_. However, we did not find any indication of species differences in their antipredator strategies. **Although _L. delicata_ showed some degree of antipredator plasticity-—reflected by a positive slope in the probability of emerging from shelter over time-—_L. guichenoti_ did not show such pattern. However, slope contrasts between species did not reveal detectable differences, so differences in antipredator plasticity between both species is inconclusive. As such, our findings suggest that antipredator strategies do not seem to be a good predictor of the differences in invasion success between these species.**            

**In addition, both species responded similarly to early-life conditions, with neither prenatal CORT or incubation temperature affecting their antipredator response or plasticity. Some studies show that invasive species are more plastic and responsive to environmental conditions than non-invasive species [@cordeschi2022plastic; @iglesias2024maternal]. However, we did not find any differences in plasticity between _L. delicata_ and _L. guichenoti_, at least on their antipredator strategies [see also @recio2025cognitive; @recio2025early]. Future research should explore other behavioral traits that could explain the differences in invasion success between these species and how this traits can be shaped by developmental conditions.**    

#### Conclusion
**Our study shows that early-life conditions did not influence how skinks respond to a simulated attack. The antipredator behavior and antipredator plasticity in both _Lampropholis delicata_ and _L. guichenoti_ were not affected by prenatal CORT and incubation temperature. We also found that only _Lampropholis delicata_ showed some plasticity in their antipredator strategies, reflected by the increased the probability of emerging from the shelter over time. However, when both species were compared, the differences were not significant. Together, these findings suggest that antipredator response and antipredator plasticity in both species are robust to incubation temperature and prenatal GC exposure, and that both species follow similar antipredator strategies. Future studies should evaluate whether more complex developmental environments can shape antipredator phenotypes. Besides, it is fundamental to integrate behavioral assays with neurological measures to understand the mechanisms underlying antipredator response and plasticity. Finally, including other reptile species in this type of studies will help determine whether the robustness of antipredator behavior to prenatal conditions is unique to _Lampropholis_ or represents a broader pattern.**         
...
_Table S1. Contrasts of the posterior distributions of the predictors for each behavioral variable modelled for L. delicata. The contrasts are between the intercepts (Response) and slopes (Plasticity) of the different treatments. 95% Highest Posterior Density Intervals (95% HPDI) test the hypothesis that the contrasts are different from zero._     
...
table_deli_behavior <- flextable(contrast_deli_beh) %>%
  ...
  flextable::add_header_row(values = c("", "Response", "Plasticity"), colwidths = c(2, 2, 2)) %>% # Add a header row
...
_Table S2. Contrasts of the posterior distributions of the predictors for each behavioral variable modelled for L. guichenoti. The contrasts are between the intercepts (Response) and slopes (Plasticity) of the different treatments. 95% Highest Posterior Density Intervals (95% HPDI) test the hypothesis that the contrasts are different from zero._    
...
table_guich_behavior <- flextable(contrast_guich_beh) %>%
  ...
  align(align = "center", j = c(3:6), part = "body") %>%
  align(align = "center", i = c(1,2), j = c(1:6), part = "header") %>%
  flextable::bold(i = 7, j = c(3,4), bold = TRUE, part = "body") %>%  
autofit()
#
...
_Table S3. Values of the slopes (indicator of Plasticity) for the different treatments for each behavioral variable modelled for both species. Median shows the median values of the posterior distribution. 95% Highest Density Intervals (95% HPDI) test the hypothesis that the slopes are different from zero._
