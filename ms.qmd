...
Given the known effects of prenatal GCs on brain development and HPA/HPI function [@jafari2017prenatal; @lemaire_prenatal_2000; @abayarathna_effects_2020; @crino2024eggs], we hypothesized that prenatal CORT exposure would enhance immediate antipredator response but reduce antipredator plasticity. We did not expect a main effect of incubation temperature on the immediate antipredator response [@iglesias2024maternal], but incubation at warmer temperatures is predicted to enhance antipredator plasticity [@amiel_smart_2011; @amiel_hotter_2012; @amiel_effects_2017]. The interactive effects of incubation temperature and prenatal CORT on the immediate antipredator behaviour are less clear. Incubation at colder temperatures and resource-limited conditions has been associated with reduced antipredator responses in _L. delicata_ [@iglesias2024maternal], suggesting that energy availability during development can modulate antipredator responses. Elevations of metabolic rates due to higher incubation temperatures in CORT-treated embryos [@owen2019maternal] could accelerate nutrient depletion during development, decreasing energy availability and potentially reducing antipredator responses in CORT-treated warm-incubated lizards. However, metabolic rate elevations could help metabolise CORT faster, reducing the effects of prenatal CORT on antipredator responses. Given these competing mechanisms, we explored the interaction between incubation temperature and prenatal CORT on the immediate antipredator response without making a directional prediction. In contrast, warmer temperatures are predicted to buffer the effect of prenatal CORT on antipredator plasticity by enhancing cognitive processes [@amiel_smart_2011; @amiel_hotter_2012; @amiel_effects_2017].

Finally, we explored potential species differences in the effects of prenatal conditions on antipredator strategies. Only _L. delicata_ has been reported as a successful coloniser outside their natural range despite both species sharing similar life-histories, habitats, and distributions [@chapple_know_2011; @chapple_biology_2014]. These differences in the ability to colonise new environments are not related to cognitive abilities [@chapple_know_2011; @recio2025cognitive; @recio2025early], but could be associated with differences in personality [@chapple_know_2011], which may be linked to different antipredator strategies and plasticity [@amo2005flexibility; @horvath2020ain].                    
...
_Lampropholis guichenoti_: We found no effect of prenatal CORT, temperature, nor their interaction on the immediate antipredator response of _L. guichenoti_ (see @fig-results_beh_guich A, D, G and Table S2 in _Supplementary Material_). We did not see any effect of SVL on any of the behavioral responses (see Table S5 in _Supplementary Material_) either.       
...
#### Do prenatal conditions affect the antipredator flexibility?
...
#### Do species differ in their antipredator response and flexibility?
...
#### Conclusion
Our study shows that early-life conditions did not influence how skinks respond to a simulated attack. The antipredator behavior and antipredator flexibility in both _Lampropholis delicata_ and _L. guichenoti_ were not affected by prenatal CORT and incubation temperature. We also found that only _Lampropholis delicata_ showed some flexibility in their antipredator strategies, reflected by the increased the probability of emerging from the shelter over time. However, when both species were compared, the differences were not significant. Together, these findings suggest that antipredator response and antipredator flexibility in both species are robust to incubation temperature and prenatal GC exposure, and that both species follow similar antipredator strategies. Future studies should evaluate whether more complex developmental environments can shape antipredator phenotypes. Besides, it is fundamental to integrate behavioral assays with neurological measures to understand the mechanisms underlying antipredator response and flexibility. Finally, including other reptile species in this type of studies will help determine whether the robustness of antipredator behavior to prenatal conditions is unique to _Lampropholis_ or represents a broader pattern.         
