...
plot_deli_BEH <- ggplot(deli_stressor, aes(x = Day, y = lat_to_move, fill=interaction(cort,temp))) +  
...
plot_guich_BEH <- ggplot(guich_stressor, aes(x = Day, y = lat_to_move, fill=interaction(cort,temp))) +  
  geom_boxplot(outlier.shape = NA) +
  ylim(0, 450) +
  scale_fill_manual(values = c("CORT.Cold"="black", "Control.Cold"="grey", "CORT.Hot"="orange2", "Control.Hot"="moccasin"),
    labels=c("CORT-Cold (n=10)", "Control-Cold (n=7)", "CORT-Hot (n=11)", "Control-Hot (n=10)")
