...
However, there is considerable variation in how animals cope with predation risk [@stankowich2005fear; @thaker2009alternative; @horvath2020ain]. Some individuals exhibit strong antipredator responses or adjust more accurately their strategies under changing risk levels than others [@stankowich2005fear; @thaker2009alternative]. Cognition and the stress response system can be key factors predicting individual differences in the antipredator response [@griffin2001learning; @kelley2003learned; @shier2007effects; @thaker2009acute; @thaker2010stress]. Making informed decisions about when and how to respond to a threat relies both on detecting and recognising predators as well as on the ability to adjust their antipredator response over time--antipredator plasticity [@kim2016fixed]. Both predator recognition and antipredator plasticity are dependent on cognitive processes, making cognition central to antipredator responses [@griffin2001learning; @kelley2003learned; @wooster2024animal]. In addition, the stress response system--mediated by the hypothalamic-pituitary-adrenal (HPA) or hypothalamic-pituitary-interrenal (HPI) axis--plays a crucial role in mediating behavioral and physiological responses to predation [@thaker2009acute; @thaker2010stress]. Under threat, the HPA/HPI axis triggers the release of glucocorticoids (GCs), which help mobilize resources to cope with imminent risk [@sapolsky_how_2000]. Individual differences in HPA/HPI reactivity can influence the intensity and duration of antipredator responses, as well as the ability to adjust these responses with experience [@koolhaas1999coping]. Therefore, any factors influencing cognitive processes or HPA/HPI function will affect antipredator strategies and their plasticity.   

Early-life environment is a critical factor for the development of both cognitive processes and the HPA/HPI axis function [@lemaire_prenatal_2000; @jafari2017prenatal; @abayarathna_effects_2020; @crino2024eggs]. Stressful conditions during development can lead to long-lasting alterations in cognitive abilities and GCs regulation [@lemaire_prenatal_2000; @zhu_prenatal_2004; @jafari2017prenatal; @crino2024eggs]. Prenatal stress usually increases HPA/HPI responsiveness through elevated baseline GC, higher increases in the secretion of GCs after a disturbance, or a reduction in GC recovery [@crino_corticosterone_2014; @thayer2018impact; @crino2024eggs]. Although evidence is mixed, most studies suggest that prenatal GC elevations produce individuals that are more reactive to threats, for instance hiding for longer after a threat or increasing flight initiation distance [@koolhaas1999coping; @jafari2017prenatal]. In addition, elevating GCs during development can impair cognitive processes involved in learning and memory [@lemaire_prenatal_2000; @zhu_prenatal_2004], directly affecting antipredator plasticity. However, the effects of prenatal stress on antipredator responses and plasticity may be amplified or buffered by other factors. Temperature is particularly relevant in this regard, as a prominent driver of cognitive processes in ectotherms, including those associated with predator recognition and antipredator plasticity [@burger_antipredator_1998; @amiel_smart_2011; @dayananda_incubation_2017; @noble_developmental_2018; @vila_pouca_incubation_2018; @vila_pouca_quantity_2019; @abayarathna_effects_2020]. Yet, the combined effects of prenatal stress and thermal environment on antipredator strategies and their plasticity remain poorly understood.    

The aim of the present study is to examine how prenatal conditions--particularly prenatal GCs exposure and thermal environment--can shape the antipredator response in lizards. We investigated the combined effects of prenatal corticosterone (CORT)--the primary GC in reptiles--and incubation temperature on the antipredator behavior and the antipredator plasticity in two closely related skink species, the delicate skink (_Lampropholis delicata_) and the common garden skink (_L. guichenoti_). We experimentally manipulated CORT levels in eggs and incubated them at either cold or hot temperatures. After hatching, we assessed the lizards' immediate antipredator response (i.e. after exposure to an unfamiliar threat) and their ability to adjust this behavior over repeated exposures to a simulated predator attack. Given the known effects of prenatal GCs on brain development and HPA/HPI function [@jafari2017prenatal; @lemaire_prenatal_2000; @abayarathna_effects_2020; @crino2024eggs], we hypothesized that prenatal CORT exposure would enhance immediate antipredator response (i.e. longer time spent freezing or hiding after a threat) but reduce antipredator plasticity (i.e. lower behavioural change throughout the experiment). We did not expect a main effect of incubation temperature on the immediate antipredator response [@iglesias2024maternal], but incubation at warmer temperatures is predicted to enhance antipredator plasticity [@amiel_smart_2011; @amiel_hotter_2012; @amiel_effects_2017].    
...
We used the posterior distributions of model parameters to test for differences between prenatal conditions. Differences in the model intercepts between conditions were interpreted as differences in the immediate antipredator behavior, while differences in the slopes were interpreted as differences in antipredator flexibility. We used the 95% Highest Posterior Density Intervals (95% HPDI) using the hdi function in bayestestR [@bayestestR] to test if the contrasts between treatments or the slopes for each treatment were different from zero.       
...
_Lampropholis delicata_: Neither prenatal CORT, temperature, nor their interaction had a significant effect on the antipredator response on the antipredator behavior of _L. delicata_ (see @fig-results_beh_deli A, D, G and Table S1 in _Supplementary Material_). SVL had no significant effect on any of the behavioral responses (see Table S4 in _Supplementary Material_).         


_Lampropholis guichenoti_: Neither prenatal CORT, temperature, nor their interaction had a significant effect on the antipredator response on _L. guichenoti_ (see @fig-results_beh_guich A, D, G and Table S2 in _Supplementary Material_). We did not see any significant effects of SVL on any of the behavioral responses (see Table S5 in _Supplementary Material_).       
...
_Lampropholis guichenoti_: We did not see any antipredator flexibility in _L. guichenoti_, reflected by slopes being no different from 0 (see @fig-results_beh_guich B, C, E, F, H, I and Table S3 in _Supplementary Material_).       
...
Neither the immediate antipredator response nor the antipredator flexibility differed between species for any of the treatments and behavioral responses analyzed (see @table-species-contrasts).
